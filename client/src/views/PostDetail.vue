        ...
        <v-row>
            <v-col sm="10" class="pa-4 mx-auto">
                <v-card class="pa-2" outline shaped>
                    <v-img :src="domain + posts.image" class="fix-image"></v-img>
                    <v-card-action class="pb-0">
                        <v-row class="mt-1 mx-1">
                            ...
                            <v-col sm="10" class="d-flex justify-end">
                                <v-btn :to="{ name: 'edit-post', params: { id: posts._id } }" color="success" class="mr-2"
                                    rounded elevation="7" outlined>Edit</v-btn>
                                <v-btn @click="removePost(posts._id)" color="error" rounded elevation="7"
                                    outlined>Delete</v-btn>
                            </v-col>
                        </v-row>
                    </v-card-action>
